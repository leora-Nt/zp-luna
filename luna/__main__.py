...
from luna.menu import *
from luna import *
from luna.plugins import ALL_MODULES
from luna.utils import paginate_modules
from lang import get_command
from luna.utils.lang import *
from luna.utils.commands import *
from luna.mongo.rulesdb import *
from luna.utils.start import *
from luna.mongo.usersdb import *
from luna.mongo.restart import *
from luna.mongo.chatsdb import *
...
async def start_bot():
    ...
    for module in ALL_MODULES:
        imported_module = importlib.import_module("luna.plugins." + module)
        if (
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(
                text="📓 Documentation",
                url=f"https://szsupunma.gitbook.io/luna-bot/",
            )
        ],
        [
            InlineKeyboardButton(
...
have a look at my [Docs](https://szsupunma.gitbook.io/luna-bot/), or head to @szteambots.
