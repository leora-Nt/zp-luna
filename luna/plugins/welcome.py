...
from luna import *
from luna.mongo.gban import GBan
from luna.mongo.welcomedb import Greetings
from luna.utils.custom_filters import admin_filter, command
...
my news channel @Theszlunabot.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/szlunabot?start=help"),
            ]))
