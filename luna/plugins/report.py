...
from luna.mongo.reportdb import Reporting
...
luna will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. luna assumes that admins 
