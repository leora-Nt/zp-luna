...
from luna.mongo.language import *
...
__HELP__ = """
Not every group speaks fluent english; some groups would rather have luna respond in their own language.
