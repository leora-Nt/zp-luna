...
from luna.utils.custom_filters import (
    owner_filter,
)
from luna.core.decorators.permissions import adminsOnly
from pyrogram import filters
from pyrogram.types import Message
from luna.utils.caching import ADMIN_CACHE, TEMP_ADMIN_CACHE_BLOCK, admin_cache_reload
from luna.utils.parser import mention_html
...
from pyrogram import filters
from pyrogram.types import Message
from luna.plugins.rules import *
from luna import BOT_ID, SUDOERS, app
from lang import get_command
from luna.utils.functions import extract_user
...
Sometimes, you promote or demote an admin manually, and luna doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
...
that'll force luna to check who the admins are again. 
"""
