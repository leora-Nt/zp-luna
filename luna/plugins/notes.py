...
from luna.mongo.notesdb import Notes, NotesSettings
from luna.utils.cmd_senders import send_cmd
from luna.utils.custom_filters import admin_filter, command, owner_filter
from luna.utils.kbhelpers import rkb as ikb
from luna.utils.msg_types import Types, get_note_type
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/szlunabot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/szlunabot?start=notes_{grp_id}",
                        "url",
                    ),
                ],
            ],
